...
const int Armmotor1 = 9; // the pin of arm motor1
const int Armmotor2 = 3; // the pin of arm motor2
const int Armmotor3 = A3; // the pin of arm motor3
...
const int SW = A4; // button on the Joystick
