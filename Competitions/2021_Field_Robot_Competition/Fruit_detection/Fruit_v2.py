...
tomato_area, TOMATO = find_tomato(frame,6000,Hmin_red1_phase1, Smin_red1_phase1, Vmin_red1_phase1, Hmax_red1_phase1, Smax_red1_phase1, Vmax_red1_phase1, Hmin_red2_phase1, Smin_red2_phase1, Vmin_red2_phase1, Hmax_red2_phase1, Smax_red2_phase1, Vmax_red2_phase1)
print(tomato_area,TOMATO)

lemon_area, LEMON = find_lemon(frame,6500,Hmin_green_phase1,Smin_green_phase1,Vmin_green_phase1,Hmax_green_phase1,Vmax_green_phase1,Vmax_green_phase1)
print(lemon_area, LEMON)

avocado_area, AVOCADO = find_avocado(frame,6500,Hmin_black_phase1,Smin_black_phase1,Vmin_black_phase1,Hmax_black_phase1,Vmax_black_phase1,Vmax_black_phase1)
