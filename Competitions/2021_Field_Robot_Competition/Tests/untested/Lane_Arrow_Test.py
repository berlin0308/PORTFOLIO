...
def HoughLinesAnalysis(focus,lines):
    if lines is not None:
        ...
        if Plist == [] or Nlist == [] :
            ...
            print("time1:",(PHASE6 - PHASE5).microseconds//1000, "ms")
            
            print("time2:",(PHASE7 - PHASE6).microseconds//1000, "ms")
        ...
        if Distance < Observ_Distance:
            ...
            if Distance <= Critical_Distance:
                ...
                if countLess >= 3:
                    ...
                    for i in range(10):  # flash white lights
                        write_Serial(1,1,1,ArrowDirResult,0,0,1,1,0,0)  
                        time.sleep(1)
                        write_Serial(1,1,1,ArrowDirResult,0,0,0,0,1,1)
                        time.sleep(1)
                        
                    
        if FINDLANE == False:
            print("Stop finding Lane !!!")
            MOTION_STATE = "FindArrow"
