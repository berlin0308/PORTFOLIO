...
R1_threshold, R2_threshold = 0.1, 0.2
L1_threshold, L2_threshold = 0.1, 0.2

pwm_base_normal = 40
pwm_base_slower = 30

R1_delta, R2_delta = 20, 15
L1_delta, L2_delta = 20, 15
...
def find_lane(frame):
    ...
    """ mark the area """
    cv2.putText(marked, str(R1_Area*100), (340,250), cv2.FONT_HERSHEY_PLAIN, 2, (90,100,200), 1, cv2.LINE_AA) 
    cv2.putText(marked, str(L1_Area*100), (60,250), cv2.FONT_HERSHEY_PLAIN, 2, (90,100,0), 1, cv2.LINE_AA) 
    
    cv2.putText(marked, str(R2_Area*100), (410,270), cv2.FONT_HERSHEY_PLAIN, 1, (90,100,200), 1, cv2.LINE_AA) 
    cv2.putText(marked, str(L2_Area*100), (27,270), cv2.FONT_HERSHEY_PLAIN, 1, (90,100,0), 1, cv2.LINE_AA) 
