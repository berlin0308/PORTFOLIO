...
poly_h, poly_w, L = 200, 120, 220

deltaHALT, deltaALERT, deltaAUX = 60, 100, 190
...
""" read file """
path = "C:\\Users\\BERLIN CHEN\\Desktop\\2021FR\\Photos\\findlane5.jpg"
img = cv2.imread(path)
...
pts_o = np.float32([[0,480], [320-poly_w,480-poly_h], [320+poly_w,480-poly_h], [640,480]])
pts_d = np.float32([[320-L,480], [320-L,480-poly_h], [320+L,480-poly_h], [320+L,480]])
...
cv2.polylines(img,pts=[polygon],isClosed=True,color=(120,120,225),thickness=3) # draw polygon on img
output1 = cv2.hconcat([img, trapezoid_stencil])
...
cv2.line(marked, (L-deltaALERT, 0), (L-deltaALERT, 480), (90, 100, 200), 2)
cv2.line(marked, (L+deltaALERT, 0), (L+deltaALERT, 480), (90, 100, 200), 2)

cv2.line(marked, (L-deltaAUX, 0), (L-deltaAUX, 480), (60, 100, 200), 2)
cv2.line(marked, (L+deltaAUX, 0), (L+deltaAUX, 480), (60, 100, 200), 2)
