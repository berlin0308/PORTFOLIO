    ...
    try:
        ...
        if contours:   
            ...
            for cnt in cnt_map:
                ...
                ifArrow2, credit2, arrowDir2, coef2, contoursImage  = convex_vertices_Test(contoursImage,cnt,6,0)
                ifArrow3, credit3, arrowDir3, coef3, contoursImage  = x_config_Test(contoursImage,cnt,3,2)
                ifArrow4, credit4, arrowDir4, coef4, contoursImage  = y_config_Test(contoursImage,cnt,2,0)
                ifArrow5, credit5, arrowDir5, coef5, contoursImage  = M_pos_Test(contoursImage,cnt,2,0)
                ifArrow6, credit6, arrowDir6, coef6, contoursImage  = least_area_Test(contoursImage,cnt,10,0)
                ifArrow7, credit7, arrowDir7, coef7, contoursImage  = least_arclength_Test(contoursImage,cnt,4,0)
                ifArrow8, credit8, arrowDir8, coef8, contoursImage  = convexity_defect_Test(contoursImage,cnt,2,0)
                ifArrow9, credit9, arrowDir9, coef9, contoursImage  = concave_vertices_Test(contoursImage,cnt,2,0)
            ...
            a,b,xconfigDir,d,contoursImage = x_config_Test(contoursImage,best_cnt,2,2)
